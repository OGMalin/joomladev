...
?>
<!-- About dialog -->
<div id="about" class="modal fade" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="aboutLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h3 class="modal-title">PolarBook</h3>
			</div>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" data-dismiss="modal"><?php echo JText::_('COM_POLARBOOK_OK') ?></button>
			</div>
		</div>
	</div>
</div>
...
<!-- File New dialog -->
<div id="filenew" class="modal fade" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="fileNewLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h3 class="modal-title"><?php echo JText::_('COM_POLARBOOK_FILENEW_LABEL') ?></h3>
			</div>
			<div class="modal-body">
				<label><?php echo JText::_('COM_POLARBOOK_FILENEW_NAME') ?></label>
				<input class="form-control" id='filenewname' type='text'></input>
			</div>
			<div class="modal-footer">
				<button class="btn btn-default" data-dismiss="modal"><?php echo JText::_('COM_POLARBOOK_CANCEL') ?></button>
				<button class="btn btn-primary" data-dismiss="modal" onclick='menuFileNew();return false;'><?php echo JText::_('COM_POLARBOOK_SAVE') ?></button>
			</div>
		</div>
	</div>
</div>
...
<!-- File Open dialog -->
<div id="fileopen" class="modal fade" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="fileOpenLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h3 class="modal-title" id="fileOpenLabel"><?php echo JText::_('COM_POLARBOOK_FILEOPEN_LABEL') ?></h3>
			</div>
			<div class="modal-body">
			...
			<div class="modal-footer">
				<button class="btn btn-default" data-dismiss="modal"><?php echo JText::_('COM_POLARBOOK_CANCEL') ?></button>
				<button class="btn btn-primary" data-dismiss="modal" onclick="menuFileOpen(1);return false;"><?php echo JText::_('COM_POLARBOOK_OK') ?></button>
			</div>
		</div>
	</div>
</div>
...
<!-- File delete dialog -->
<div id="filedelete" class="modal fade" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="fileDeleteLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h3 class="modal-title" id="fileDeleteLabel"><?php echo JText::_('COM_POLARBOOK_FILEDELETE_LABEL') ?></h3>
			</div>
			<div class="modal-body">
				<label><?php echo JText::_('COM_POLARBOOK_FILEDELETE_NAME') ?></label>
				<input class="form-control" id='filedeletename' readonly='readonly' type='text' value=''></input>
			</div>
			<div class="modal-footer">
				<button class="btn btn-default" data-dismiss="modal"><?php echo JText::_('COM_POLARBOOK_CANCEL') ?></button>
				<button class="btn btn-primary" data-dismiss="modal" onclick="menuFileDelete(1);return false;"><?php echo JText::_('COM_POLARBOOK_DELETE') ?></button>
			</div>
		</div>
	</div>
</div>
...
<!-- File Trash dialog -->
<div id="filetrash" class="modal fade" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="fileTrashLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			...
			<div class="modal-body">
				<label><?php echo JText::_('COM_POLARBOOK_FILETRASH_NAME') ?></label>
 				<div id='filetrashselect'></div>
			</div>
			<div class="modal-footer">
				<button class="btn btn-primary" data-dismiss="modal" onclick="menuFileTrash(2);return false;"><?php echo JText::_('COM_POLARBOOK_RECOVER') ?></button>
				<button class="btn btn-default" data-dismiss="modal"><?php echo JText::_('COM_POLARBOOK_CANCEL') ?></button>
				<button class="btn btn-danger" data-dismiss="modal" onclick="menuFileTrash(1);return false;"><?php echo JText::_('COM_POLARBOOK_DELETE') ?></button>
			</div>
		</div>
	</div>
</div>
